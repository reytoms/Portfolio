...
The data realeased by Centers of Diseases Control and prevention highlights that 40% of US adults suffered from elevated adversarial mental health conditions during early pandemic. Younger adults, racial/ethnic minorities, and essential workers, reported having experienced disproportionately worse mental health outcomes, increased substance use, and elevated suicidal ideation.
...
Until early 2020, our mental well-being was comparatively steady and healthier until the pandemic was declared. Since then, our mental health has dropped especially with work life switching to remote, lockdowns being announced, and borders shutting down. Vacations in 2020 meant more time at home rather than an opportunity to connect with people or explore another destination. Early 2021, vaccinations were announced after which majority of the population got vaccinated.
...
**Picking a destination from over 190 countries worldwide**
...
**It could be challenging to choose a country from many options. Hence, it is important to reduce the options by the method of elimination. Below are some of the points to consider for elimination:**
...
**Finally, a highlight of the tourist attractions in the city of choice. In this sketching I have included a tour guide map for France only. But in my final project I would include more countries from the available options.**
...
I would like to use Shorthand for the final compilation of my story. From a quick research of the tool, I believe that the single page view of it will keep my story rolling by a simple scroll unlike powerpoint presentations where I have to switch over to the next slide for continuation. I hope to use interactive charts with appealing colors (especially to create a tour map of the destination), fonts, and an apt-title. I believe embedding images create personability with the viewers, so I might consider that as well.
